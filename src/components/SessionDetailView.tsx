...
// Shared by both the "just finished" Session Summary screen and History's
// Session Details screen — same layout/data, different bottom actions.
export function SessionDetailView({ sessionId, variant }: SessionDetailViewProps) {
    ...
    <div className="space-y-6 p-6">
      ...
      <Modal isOpen={confirmDelete} onClose={() => setConfirmDelete(false)} title="Delete session?">
        ...
        <div className="mt-5 flex justify-end gap-3">
          ...
          <Button variant="primary" onClick={deleteSession} disabled={deleting}>
